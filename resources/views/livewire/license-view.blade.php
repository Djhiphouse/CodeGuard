                            ...
                            @foreach($entries as $license)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
                                        ...
                                        @else
                                            <span class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">Found</span>
                                        @endif
                                    </td>
                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-500">
